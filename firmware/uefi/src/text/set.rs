...
pub type Attribute = extern "efiapi" fn(*const simple::text::output::Protocol, usize) -> Status;
...
pub type CursorPosition =
    extern "efiapi" fn(*const simple::text::output::Protocol, usize, usize) -> Status;
