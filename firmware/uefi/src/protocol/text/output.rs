...
pub type EnableCursor = extern "efiapi" fn(*const Output, bool) -> Status;
...
pub type QueryMode = extern "efiapi" fn(*const Output, usize, *mut usize, *mut usize) -> Status;

/// # References
/// * [EFI_TEXT_RESET](https://uefi.org/specs/UEFI/2.11/12_Protocols_Console_Support.html#efi-simple-text-output-protocol-reset)
pub type Reset = extern "efiapi" fn(*const Output, bool) -> Status;
...
pub type SetAttribute = extern "efiapi" fn(*const Output, usize) -> Status;
...
pub type SetCursorPosition = extern "efiapi" fn(*const Output, usize, usize) -> Status;
...
pub type SetMode = extern "efiapi" fn(*const Output, usize) -> Status;
/// # References
...
pub type String = extern "efiapi" fn(*const Output, *const Char16) -> Status;
